...
public class UserService {
  ...
  @Autowired EmailRateLimitService emailRateLimitService;
  ...
  @Transactional
  public void requestSetEmail(String userName, String siteName, String email)
    ...
    tokenRepository.save(
        new VerificationToken(u.get(), randomKey, VerificationToken.Purpose.VERIFY_EMAIL, email));
  ...
  @Transactional
  public void requestResetForgottenPassword(
      String userName, String siteName, String email, String password) throws MessagingException {
    Optional<User> u = userRepository.findByUserName(userName);
    ...
    tokenRepository.save(
        new VerificationToken(
            u.get(), randomKey, VerificationToken.Purpose.RESET_PASSWORD, passwordHash));
    String body = templateService.getVerifyEmailTemplate(site, email, userName, randomKey);
