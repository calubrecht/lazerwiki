...
public class UserService {
  ...
  @Transactional
  public void requestSetEmail(String userName, String host, String email)
  ...
  public void requestResetForgottenPassword(
      String userName, String host, String email, String password) throws MessagingException {
    Optional<User> u = userRepository.findByUserName(userName);
