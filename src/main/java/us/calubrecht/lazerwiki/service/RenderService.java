...
public class RenderService {
    ...
    public PageData getRenderedPage(String host, String sPageDescriptor, String userName, PerfTracker perfTracker) {
        ...
        if (d.flags().moved()) {
            ...
            return new PageData(rendered.renderedText(), d.source(), d.title(), d.tags(), d.backlinks(), d.flags(), d.id(), d.revision(), false, "", perfTracker);
        }
        if (!d.flags().exists()) {
            return d;
        }
        ...
        if (cachedPage != null && cachedPage.useCache) {
            ...
            logger.info("Render {} took ({},{},{})ms (Total,Query,QueryCache)", sPageDescriptor, totalMillis, queryMillis, totalMillis - queryMillis);
            return pd;
        }
        try {
            ...
            logger.info("Render {} took ({},{},{})ms (Total,Query,Render)", sPageDescriptor, totalMillis, queryMillis, totalMillis - queryMillis);
            return pd;
        }
        catch (Exception e) {
            logger.error("Render failed! host= {} sPageDescriptor= {} user={}.", host, sPageDescriptor, userName, e);
    ...
    public PageData getHistoricalRenderedPage(String host, String sPageDescriptor, long revision, String userName) {
        ...
        try {
            ...
            return new PageData(rendered.renderedText(), d.source(), d.title(), d.tags(), d.backlinks(), d.flags());
        }
        catch (Exception e) {
            logger.error("Render failed! host= {} sPageDescriptor= {} user={}.", host, sPageDescriptor, userName, e);
            String sanitizedSource =  StringEscapeUtils.escapeHtml4(d.source()).replace("&quot;", "\"");
    ...
    public PageData previewPage(String host, String sPageDescriptor, String text, String userName, PerfTracker perfTracker) {
        ...
        try {
            ...
            sw.stop();
            logger.error("Render preview failed! host= {} sPageDescriptor= {} user={}.", host, sPageDescriptor, userName, e);
