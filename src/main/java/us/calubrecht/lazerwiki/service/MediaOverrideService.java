...
public class MediaOverrideService {
  ...
  public void createOverride(
    ...
    List<ImageRef> linksToOverride =
        imageRefRepository.findAllBySiteAndImageNSAndImageRef(site, oldFileNS, oldFileName);
    List<MediaOverride> linkOverrides =
    ...
    List<MediaOverride> replacedLinkOverrides =
            ...
            .map(
                lo ->
                    new MediaOverride(
                        ...
                        lo.getTargetFileNS(),
                        lo.getTargetFileName(),
                        lo.getNewTargetFileNS(),
                        lo.getNewTargetFileName()))
            .toList();
