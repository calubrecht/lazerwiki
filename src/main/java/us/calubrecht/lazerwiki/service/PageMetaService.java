...
public class PageMetaService {
    ...
    public PageMetaService(
            @Autowired LinkService linkService, @Autowired LinkOverrideService linkOverrideService,
            @Autowired MediaOverrideService mediaOverrideService, @Autowired ImageRefService imageRefService,
            @Autowired RegenCacheService regenCacheService, @Autowired PageCacheRepository pageCacheRepository,
    ...
    public void updateMetaData(String host, String site, PageDescriptor pageDescriptor, Page p, Collection<String> links,
    ...
    public Pair<List<String>, List<String>> moveMetaData(String host, String site, String oldPageDescriptor, String newPageDescriptor) {
