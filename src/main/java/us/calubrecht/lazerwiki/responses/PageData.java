...
public record PageData(
  ...
  public PageData(
      String rendered, String source, List<String> tags, List<String> backlinks, PageFlags flags) {
  ...
  public static final PageFlags EMPTY_FLAGS =
      new PageFlags(false, false, false, false, false, false);
