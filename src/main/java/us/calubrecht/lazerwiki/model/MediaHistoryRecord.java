...
public class MediaHistoryRecord {
  ...
  @CreationTimestamp private LocalDateTime ts;

  public MediaHistoryRecord() {}

  public MediaHistoryRecord(
      String fileName, String site, String namespace, User uploadedBy, ActivityType activity) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, that.id)
        ...
        && Objects.equals(uploadedByUser, that.uploadedByUser)
