...
public class ImageRef {
  ...
  public ImageRef(
      String site, String sourcePageNS, String sourcePageName, String imageNS, String imageRef) {
    this.site = site;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, imageRef1.id)
        && site.equals(imageRef1.site)
        && sourcePageNS.equals(imageRef1.sourcePageNS)
        && sourcePageName.equals(imageRef1.sourcePageName)
        && imageNS.equals(imageRef1.imageNS)
        && imageRef.equals(imageRef1.imageRef);
  }
