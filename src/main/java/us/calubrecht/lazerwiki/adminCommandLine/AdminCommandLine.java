...
@Component
@ConditionalOnProperty(value = "admin.command-line.enabled", havingValue = "true")
public class AdminCommandLine implements CommandLineRunner {
  private static final Logger logger = LoggerFactory.getLogger(AdminCommandLine.class);
