...
class HistoryControllerTest {
  ...
  @Autowired HistoryController controller;
  ...
  void test_recentChanges() throws Exception {
    ...
    medias.add(
        new MediaHistoryRecord(
            "img1.jpg", "site1", "ns", user, ActivityType.ACTIVITY_PROTO_UPLOAD_MEDIA));
    medias.get(0).setTs(LocalDateTime.of(2022, 01, 01, 10, 10, 0));
    medias.add(
        new MediaHistoryRecord(
            "img2.jpg", "site1", "ns", user, ActivityType.ACTIVITY_PROTO_UPLOAD_MEDIA));
    ...
    ((PageServiceTest.PageDescImpl) pages.get(0))
        .setModified(LocalDateTime.of(2021, 11, 01, 10, 10, 0));
    pages.add(new PageServiceTest.PageDescImpl("ns", "page2", 1L));
    ((PageServiceTest.PageDescImpl) pages.get(1))
        .setModified(LocalDateTime.of(2021, 10, 01, 10, 10, 0));
    RecentChangesResponse pagesRes =
  ...
  void test_mergePageAndMedia() {
    ...
    pages.add(new PageServiceTest.PageDescImpl("ns", "page2", 1L));
    ((PageServiceTest.PageDescImpl) pages.get(2))
        .setModified(LocalDateTime.of(2020, 10, 01, 10, 10, 0));
    pages.add(new PageServiceTest.PageDescImpl("ns", "page2", 1L));
    ((PageServiceTest.PageDescImpl) pages.get(3))
        .setModified(LocalDateTime.of(2019, 10, 01, 10, 10, 0));
    pages.add(new PageServiceTest.PageDescImpl("ns", "page2", 1L));
    ((PageServiceTest.PageDescImpl) pages.get(4))
        .setModified(LocalDateTime.of(2018, 10, 01, 10, 10, 0));
    pages.add(new PageServiceTest.PageDescImpl("ns", "page2", 1L));
    ((PageServiceTest.PageDescImpl) pages.get(5))
        .setModified(LocalDateTime.of(2012, 10, 01, 10, 10, 0));
    pagesRes =
        new RecentChangesResponse(
            pages.stream().map(RecentChangesResponse::recFor).toList(), null, null);
