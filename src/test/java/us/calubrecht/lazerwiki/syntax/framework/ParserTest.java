...
class ParserTest {
  ...
  void test_parse_testPositionHandling_Other() {
    ...
    assertEquals(
        "|Second|", (cn(table.getChildren().get(1)).getChildren().get(0)).getSourceFromContext());
    ...
    assertEquals(
        "|Cell [[Link| with a link]]|",
        (cn(table.getChildren().get(1)).getChildren().get(1)).getSourceFromContext());
  ...
  void test_parseTable() {
    ...
    verifySpans(
        (TableNode.TableCellNode) cn(table.getChildren().get(1)).getChildren().get(0), 2, 1);
    // 1st row's cells still rowspan 1
    verifySpans(
        (TableNode.TableCellNode) cn(table.getChildren().get(0)).getChildren().get(0), 1, 1);
    verifySpans(
        (TableNode.TableCellNode) cn(table.getChildren().get(0)).getChildren().get(1), 1, 1);
    ...
    assertEquals(1, cn(table.getChildren().get(1)).getChildren().size());
    verifySpans(
        (TableNode.TableCellNode) cn(table.getChildren().get(0)).getChildren().get(1), 1, 2);
    // Other cells still have correct span
    verifySpans(
        (TableNode.TableCellNode) cn(table.getChildren().get(0)).getChildren().get(0), 1, 1);
    verifySpans(
        (TableNode.TableCellNode) cn(table.getChildren().get(1)).getChildren().get(0), 1, 1);
  }
