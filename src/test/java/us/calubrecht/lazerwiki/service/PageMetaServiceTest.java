...
class PageMetaServiceTest {
  ...
  @InjectMocks PageMetaService underTest;

  @Mock LinkService linkService;

  @Mock LinkOverrideService linkOverrideService;

  @Mock MediaOverrideService mediaOverrideService;

  @Mock ImageRefService imageRefService;

  @Mock RegenCacheService regenCacheService;

  @Mock PageCacheRepository pageCacheRepository;

  @Mock EntityManagerProxy em;
  ...
  void test_updateMetaData() {
    ...
    verify(imageRefService)
        .setImageRefsFromPage("site1", "ns1", "existing_page", List.of("img1", "img2"));
