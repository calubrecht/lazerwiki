...
public class DokuWikiRendererTest {
  ...
  void test_renderHeader() {
    ...
    assertEquals(
        "<div>===Doesn't parse as header=== with trailing</div>",
        doRender("===Doesn't parse as header=== with trailing"));
  }
  ...
  void test_renderHeaderImbalance() {
    ...
    assertEquals(
        "<h1 id=\"header_Header_with_unmatching_tokens\">Header with unmatching tokens</h1>",
        doRender(source));
    source = "==== Mismatched the other way =====";
    assertEquals(
        "<h3 id=\"header_Mismatched_the_other_way\">Mismatched the other way</h3>",
        doRender(source));
  ...
  void test_renderHeaderSanitize() {
    ...
    assertEquals(
        "<h1 id=\"header__script_doAlert__Gotcha_____script_\">&lt;script&gt;doAlert(\"Gotcha\");&lt;/script&gt;</h1>",
        doRender(source));
  }
  ...
  void test_renderLink() {
    ...
    assertEquals(
        ...
        doRender("======Some text in [[ headerLink |a header]]======"));
  ...
  public void test_renderLinkSanitizesLinks() {
    ...
    assertEquals(
        ...
        doRender(linkEmbeddingJS)); // quotes force link parsing to fail

    // External Link
    assertEquals(
        "<div>[[https://ListGoesWhere\" onclick=\"evil</div>",
        doRender("[[https://ListGoesWhere\" onclick=\"evil"));
  }
  ...
  public void test_renderSanitizeHtmlInText() {
    ...
    assertEquals(
        "<div>Escape &lt;b&gt;this&lt;/b&gt; but not <a class=\"wikiLinkMissing\" href=\"/page/aLink\"> a link</a> and &lt;b&gt;escape&lt;/b&gt; again</div>",
        doRender("Escape <b>this</b> but not [[ aLink | a link]] and <b>escape</b> again"));
  }
  ...
  public void test_linebreaks() {
    ...
    assertEquals(
        "<div>A double linebreak in the source</div>\n<div>breaks in to paragraphs</div>",
        doRender(input2));
  }
  ...
  public void test_renderBold() {
    ...
    assertEquals(
        "<div>Some bolds <span class=\"bold\">have <a class=\"wikiLinkMissing\" href=\"/page/link\">links</a> </span></div>",
        doRender(input2));
  ...
  public void test_renderItalic() {
    ...
    assertEquals(
        "<div>Some italics <span class=\"italic\">have <a class=\"wikiLinkMissing\" href=\"/page/link\">links</a> </span></div>",
        doRender(input2));
    ...
    assertEquals(
        "<div>Can <span class=\"italic\">italic\nspan lines?</span></div>", doRender(input4));
    String input5 = "Can **//italic be in// bold**?";
    assertEquals(
        "<div>Can <span class=\"bold\"><span class=\"italic\">italic be in</span> bold</span>?</div>",
        doRender(input5));
    String input6 = "Can //**bold be in** italic//?";
    assertEquals(
        "<div>Can <span class=\"italic\"><span class=\"bold\">bold be in</span> italic</span>?</div>",
        doRender(input6));
  }
  ...
  public void test_renderUnderline() {
    ...
    assertEquals(
        "<div><span class=\"underline\">This <a class=\"wikiLinkMissing\" href=\"/page/underline\">under line</a></span> should have a link</div>",
        doRender(input2));
    ...
    assertEquals(
        "<div>Can <span class=\"underline\">underlines\nspan lines?</span></div>",
        doRender(input4));
    String input5 = "Can **__underline be in__ bold**?";
    assertEquals(
        "<div>Can <span class=\"bold\"><span class=\"underline\">underline be in</span> bold</span>?</div>",
        doRender(input5));
    String input6 = "Can __**bold be in** underline__?";
    assertEquals(
        "<div>Can <span class=\"underline\"><span class=\"bold\">bold be in</span> underline</span>?</div>",
        doRender(input6));
  }
  ...
  public void test_renderUnformat() {
    ...
    assertEquals(
        "<div>This [[underline|under line]]__ should not have a link</div>", doRender(input2));
  ...
  public void test_renderMonospace() {
    ...
    assertEquals(
        "<div><span class=\"monospace\">This <a class=\"wikiLinkMissing\" href=\"/page/monospace\">monospace</a></span> should have a link</div>",
        doRender(input2));
    ...
    assertEquals(
        "<div>Can <span class=\"monospace\">monospace\nspan lines?</span></div>", doRender(input4));
    String input5 = "Can **''monospace be in'' bold**?";
    assertEquals(
        "<div>Can <span class=\"bold\"><span class=\"monospace\">monospace be in</span> bold</span>?</div>",
        doRender(input5));
    String input6 = "Can ''**bold be in** monospace''?";
    assertEquals(
        "<div>Can <span class=\"monospace\"><span class=\"bold\">bold be in</span> monospace</span>?</div>",
        doRender(input6));
  }
  ...
  public void test_renderImage() {
    ...
    assertEquals("<div>{{image.jpg</div>", doRender(inputWithBrokenImagetag));
  }
  ...
  public void test_renderMacro() {
    ...
    when(macroService.renderMacro(Mockito.startsWith("macro1: Start1"), anyString(), any()))
        .thenReturn("<div>Inside Macro 1</div>");
    when(macroService.renderMacro(Mockito.startsWith("macro2"), anyString(), any()))
        .thenReturn("<div>Inside Macro 2</div>");

    // Outside most ~~MACRO~~ and ~~/MACRO~~ tags should be matched and pass entire thing to
    // macroService
    String nestedMacro =
    ...
    assertEquals(
        "macro1: Start1 ~~MACRO~~macro2: Start2 ~~/MACRO~~ End1 ", captor.getAllValues().get(1));
  ...
  public void test_renderLinebreak() {
    ...
    assertEquals(
        "<h3 id=\"header_This_is__a_header\">This is<br> a header</h3>",
        doRender(inputBreakSymbolInHeader));

    String inputRequireWS = "This is a line\\\\with a linebreak but no spaces";
    assertEquals(
        "<div>This is a line\\\\with a linebreak but no spaces</div>", doRender(inputRequireWS));
  }
  ...
  public void test_renderTable() {
    ...
    assertEquals(
        ...
        doRender(inputSimpleTable));
    String tableWithHeader = "^Header^Line^\n|Second|Line|";
    assertEquals(
        "<table class=\"lazerTable\"><tbody><tr><th>Header</th><th>Line</th></tr>\n<tr><td>Second</td><td>Line</td></tr>\n</tbody></table>",
        doRender(tableWithHeader));
    String tableWithMixedHeader = "^Header|Line|\n|Second|Line|";
    assertEquals(
        "<table class=\"lazerTable\"><tbody><tr><th>Header</th><td>Line</td></tr>\n<tr><td>Second</td><td>Line</td></tr>\n</tbody></table>",
        doRender(tableWithMixedHeader));
    String tableWithColSpan = "^Header|Line|\n|Second||";
    assertEquals(
        "<table class=\"lazerTable\"><tbody><tr><th>Header</th><td>Line</td></tr>\n<tr><td colspan=\"2\">Second</td></tr>\n</tbody></table>",
        doRender(tableWithColSpan));
    ...
    assertEquals(
        ...
        doRender(biggerTable));
    String tableThatEnds = "|First|Line|\nIs the only line";
    assertEquals(
        "<table class=\"lazerTable\"><tbody><tr><td>First</td><td>Line</td></tr>\n</tbody></table>\n<div>Is the only line</div>",
        doRender(tableThatEnds));
  }
  ...
  public void test_renderBrokenTable() {
    ...
    assertEquals(
        """
                ...
                <div>|Cell3|Cell4 doesn't end</div>""",
        doRender(inputTable));
  }
  ...
  public void test_renderBlockquote() {
    ...
    assertEquals(
        "<blockquote> One quote <span class=\"bold\">with some bold</span>\n"
            + "<br>And<blockquote>Another layer of quote</blockquote></blockquote>",
        doRender(inputBlockquote));

    String inputBlockquoteWithBlankLines =
        "> **//Some bold//**\n>\n>A blank line\n> \n>And one with just space";
    assertEquals(
        "<blockquote> <span class=\"bold\"><span class=\"italic\">Some bold</span></span>\n<br>\n<br>A blank line\n<br> \n<br>And one with just space</blockquote>",
        doRender(inputBlockquoteWithBlankLines));

    String inputBlockquoteUpAndDown = ">One Quote\n>>TwoQuote\n>One Quote";
    assertEquals(
        "<blockquote>One Quote<blockquote>TwoQuote</blockquote>One Quote</blockquote>",
        doRender(inputBlockquoteUpAndDown));

    String inputBlockquoteThenPAragraph = ">One Quote\nNot a quote";
    assertEquals(
        "<blockquote>One Quote</blockquote><div>Not a quote</div>",
        doRender(inputBlockquoteThenPAragraph));
  }
  ...
  public void test_hidden() {
    ...
    assertEquals(
        "<div class=\"hidden\"><input id=\"hiddenToggle5\" class=\"toggle\" type=\"checkbox\"><label for=\"hiddenToggle5\" class=\"hdn-toggle\">Hidden</label><div class=\"collapsible\">simple</div></div>",
        doRender(hidden));

    assertEquals(
        "<div class=\"hidden\"><input id=\"hiddenToggle8\" class=\"toggle\" type=\"checkbox\"><label for=\"hiddenToggle8\" class=\"hdn-toggle\">Hidden</label><div class=\"collapsible\"><div>line1</div>\n<div>line2<img src=\"/_media/animage\" class=\"media\" loading=\"lazy\"></div></div></div>",
    ...
    assertEquals(
        ...
        doRender(hiddeonListStartsOnLine));

    String nameWSpace = "<hidden name=\"Name w Space\">Text</hidden>";
    assertEquals(
        "<div class=\"hidden\"><input id=\"hiddenToggle11\" class=\"toggle\" type=\"checkbox\"><label for=\"hiddenToggle11\" class=\"hdn-toggle\" data-named=\"true\">Name w Space</label><div class=\"collapsible\">Text</div></div>",
        doRender(nameWSpace));

    String twoParas = "<hidden>Para1\n\nPara2</hidden>";
    assertEquals(
        "<div class=\"hidden\"><input id=\"hiddenToggle11\" class=\"toggle\" type=\"checkbox\"><label for=\"hiddenToggle11\" class=\"hdn-toggle\">Hidden</label><div class=\"collapsible\"><div>Para1</div>\n"
            + "<div>Para2</div></div></div>",
        doRender(twoParas));

    String codeBlockInHidden = "<hidden>  A Block</hidden>";
    assertEquals(
        "<div class=\"hidden\"><input id=\"hiddenToggle11\" class=\"toggle\" type=\"checkbox\"><label for=\"hiddenToggle11\" class=\"hdn-toggle\">Hidden</label><div class=\"collapsible\"><pre class=\"code\">A Block\n"
            + "</pre></div></div>",
        doRender(codeBlockInHidden));
  ...
  public void test_hidden_nested() {
    ...
    assertEquals(
        """
                ...
                <div class="hidden"><input id="hiddenToggle4" class="toggle" type="checkbox"><label for="hiddenToggle4" class="hdn-toggle">Hidden</label><div class="collapsible">Nested hidden</div></div></div></div>""",
        doRender(nestedHidden));
  }
  ...
  public void test_renderTOC() {
    ...
    assertEquals(
        headerRender
            + "<h1 id=\"header_Header_1\">Header 1</h1>\n<h3 id=\"header_Header_2\">Header 2</h3>\n<h1 id=\"header_Header_3\">Header 3</h1>\n<h2 id=\"header_Header_2_1\">Header 2</h2>",
        doRender(source));
  }
